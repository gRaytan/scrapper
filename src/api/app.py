...
from src.api.routes import auth, scraper, users, jobs, companies, alerts, applications, saved_filters
...
app.include_router(saved_filters.router, prefix="/api/v1/users/saved-filters", tags=["saved-filters"])
