...
def list_jobs(
    ...
    titles: Optional[List[str]] = Query(None, description="Filter by exact job titles"),
    job_families: Optional[List[str]] = Query(None, description="Filter by job families (e.g., Engineering, Marketing)"),
